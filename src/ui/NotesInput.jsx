...
const NotesInput = ({ isContainNote, isNoteProtected, noteContent }) => {
  ...
  return ( <button 
    ...
    className="flex w-full items-center justify-center gap-1 p-1 bg-slate-800/30 border border-slate-800 rounded-md group hover:shadow-md hover:bg-slate-800/50 hover:border-slate-700 cursor-pointer">
